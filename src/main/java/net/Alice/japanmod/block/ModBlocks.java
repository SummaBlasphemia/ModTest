...
//FUNDAMENTOS: Ao lidarmos com blocos no minecraft, devemos nos lembrar que o bloco em si e o item do bloco são distintos um do outro,
// quando vemos o " private static<T extends Block>RegistryObject<Item>" e o " private static<T extends Block>RegistryObject<T>" o que está querendo ser dito é
//"...<Item>" estamos lidando com a versão de item do bloco, aquela que vemos na mão e no inventário do jogador, ou seja, ele está sendo manipulado como item, mesmo sendo um bloco.
//"...<T>" estamos lidando com a versão de bloco no mundo tridimensional; aqui, alteramos a maior parte das propriedades (dureza, som, cor e outros) que definem seus comportamentos no mundo tridimensional do jogo.

public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, JapanMod.MOD_ID);
